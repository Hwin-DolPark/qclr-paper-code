...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        #PTB-Indep-QCLR-0503-E20T01P20D05
        "--model_id", type=str, default="PTB-Indep-0523-E40T01P20D10G1Seed41R05BN1GLU1Res1", help="model id"
    )
    parser.add_argument(
        "--model",
        type=str,
    ...
    parser.add_argument("--q_model", type=int, default=96, help="dimension of QCLR's representation vector (v)")
