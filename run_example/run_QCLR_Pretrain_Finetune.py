...
from exp.exp_classification_prefine import Exp_Classification_PreFine
import random
import numpy as np
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="task name, options:[classification, classification_qclr, classification_qclr_pre_fine]",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        "--model_id", type=str, default="PTB-QCLR-Seed4145-PreFine", help="model id"
    )
    parser.add_argument(
        "--model",
        type=str,
        # required=True,
        default="QCLR",
        help="model name, options: [Autoformer, Transformer, TimesNet, iTransformer, Medformer]",
    )
    ...
    # data loader
    parser.add_argument(
        # "--data", type=str, required=True, default="PTB", help="dataset type"
        "--data", type=str, default="PTB", help="dataset type"
    )
    parser.add_argument(
        "--root_path",
        type=str,
    ...
    elif args.task_name == "classification_qclr_pre_fine":
        Exp = Exp_Classification_PreFine
    else:
        Exp = Exp_Long_Term_Forecast
